...
cc_pheno_file = "data/ADSPCaseControlPhenotypes_DS_2024.11.22_ALL.csv"
# fam_pheno_file = "data/ADSPFamilyBasedPhenotypes_DS_2022.08.18.v2_ALL.csv"
fam_pheno_file = "data/ADSPFamilyBasedPhenotypes_DS_2024.11.22_ALL.csv"
# adni_pheno_file = "data/ADNIPhenotypes_DS_2022.08.18.v2_ALL.csv"
adni_pheno_file = "data/ADNIPhenotypes_DS_2024.11.22_ALL.csv"
...
# there is a r5 version of this but only as a text file, not xlsx
# it is used to drop genetically identical samples so hopefully an old version 
...
write.csv(sample_pheno_output, file="ADSPIntegratedPhenotypes_DS_2024.11.22.csv", row.names = FALSE)
